...
namespace hegem::skein::op::invoke_impl
{
    ...
    auto invoke(op_fields_indirection_nop const& fields, tool::span<lib::any> args) -> lib::any
    {
        return std::move(args[0]);
    }

    auto invoke(op_fields_indirection_pack const& fields, tool::span<lib::any> args) -> lib::any
    {
    ...
    auto invoke(op_fields_indirection_unpack const& fields, tool::span<lib::any> args) -> lib::any
    {
